...
User.create!(username: "BamBamFlinstone", password: "password", password_confirmation: "password", name: "Bam-Bam Flinstone", position: "Corporal", agency_id: agency1.id, admin: true)
...
EmergencyVehicle.create!(status: "Unassigned", crew_size: 2, active: false, call_sign: "K448", agency_id: agency1.id)
EmergencyVehicle.create!(status: "Unassigned", crew_size: 2, active: false, call_sign: "K449", agency_id: agency1.id)
